...
<aside class="leftsidebar" id="navbarSupportedContent">
    <div class="leftsidebar-nav">
        <ul class="noselect">
            ...
            <li class="{{(Request::segment(2)=='orders') ? 'active_class': ''}}">
                <a href="{{route("tutor.orders.browse")}}" >
                    <span class="mdi mdi-format-list-bulleted"></span>
                    <span class="text">Browse Orders</span>
                </a>
            </li>
            <li class="{{(Request::segment(3)=='my-orders' || Request::segment(2)=='bid') ? 'active_class': '' }}">
